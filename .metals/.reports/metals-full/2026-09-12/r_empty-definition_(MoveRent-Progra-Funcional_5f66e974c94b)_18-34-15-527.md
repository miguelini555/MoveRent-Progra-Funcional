error id: file:///C:/Users/Usuario/Desktop/MoveRent-Progra-Funcional/src/main/scala/Main.scala:local24
file:///C:/Users/Usuario/Desktop/MoveRent-Progra-Funcional/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol local24
        ...
        nuevoAlquiler match {
            ...
            println(
                s"Cantidad de alquileres despues: ${
                    nuevoSi@@stema.alquileres.length
                }"
            )
            case None =>
                println(
